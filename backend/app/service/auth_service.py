...
from app.schemas.user import UserState, UserLoginSchema
...
def authenticate_user(db, username, password):
    ...
    crud_token.create_or_update_refresh_token(db, obj_in=token_in)
...
def logout_user(db: Session, user: User):
    ...
    crud_token.delete_refresh_token(db, user_id=user.user_id)
