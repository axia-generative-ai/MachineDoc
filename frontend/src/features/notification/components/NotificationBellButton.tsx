...
export function NotificationBellButton() {
  ...
  const { notifications, unreadCount, status, markAllRead, dismissNotification } = useNotificationSocket();
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {isOpen && <NotificationDropdown notifications={notifications} status={status} onDismiss={dismissNotification} />}
    </div>
  );
}
